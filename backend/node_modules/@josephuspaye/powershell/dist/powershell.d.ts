...
export declare type CommandOutputWithResult<T> = CommandOutput & {
    /**
 ...
 */
export declare function command<T = any>(command: string, options?: PowershellOptions): Promise<CommandOutputWithResult<T>>;
/**
 * Run the given PowerShell commands from a script file and get the output as a string
 */
export declare function commandsAsScript(commands: string, useChildProcess?: PowershellOptions['useChildProcess']): Promise<CommandOutput>;
